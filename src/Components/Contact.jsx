...
const Contact = () => {
  ...
  return (
    <section className="py-12 px-6" id='contact'>
      ...
      <p className='text-center text-gray-500'>For any inquiries or support requests, feel free to reach out to us at <a href="mailto:saquib1312@gmail.com" className='text-white'>saquib1312@gmail.com</a>. We will get back to you as soon as possible.</p>

      <div className="flex justify-center gap-8 py-8">
        <a href="https://www.linkedin.com/in/md-saquib-anjum-khan-414510254/" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-full">
        ...
        <a href="https://portfolio-two-kappa-1a6k6lsj6q.vercel.app/" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-full">
          <div className="p-1 social-icons">
